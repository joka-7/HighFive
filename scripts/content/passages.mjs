...
export const READINGS = {
  ...
  B2: [
    ...
    // LEVEL-AUDIT.md finding #1 noted B2's reading pool leaned heavily
    // toward one abstract, essayistic register. These six are concrete and
    // narrative instead — closer to how a B2 learner reads a personal
    // story or a local news piece, not an op-ed — to give the level real
    // range rather than more of the same style.
    R("A Second Chance at the Café (הזדמנות שנייה לבית הקפה)",
      ...
      [g("inherited", "verb", "קיבל בירושה", "She inherited the house.", "ירש"), g("regulars", "noun", "לקוחות קבועים", "The regulars know the menu.", "לקוחות קבועים"), g("gradual", "adjective", "הדרגתי, לא פתאומי", "A gradual change.", "הדרגתי")],
      [q("What did most people advise the aunt to do?", ["Sell the café", "Close it for good", "Hire more staff", "Move to a bigger space"], 0, "'everyone told her to sell it'."), q("How does the writer describe the change?", ["Sudden and dramatic", "Steady, not dramatic", "It never really worked", "Caused by luck"], 1, "'not a dramatic transformation, just a steady one'.")]),
    R("The Night the Power Went Out (הלילה שהחשמל נכבה)",
      ...
      [g("knocked out", "phrase", "גרם להפסקה/השבתה", "The storm knocked out the internet.", "גרם להפסקה"), g("gathered", "verb", "התאספו יחד", "They gathered on the porch.", "התאספו"), g("in a hurry", "phrase", "ממהר", "I'm not in a hurry.", "ממהר")],
      [q("Where did the neighbours end up gathering?", ["Inside their own homes", "On the Levis' porch", "At a café", "In the street"], 1, "'gathered on the Levis' porch'."), q("What happened between two long-time neighbours?", ["They argued", "They finally talked properly", "They left early", "They called the electric company"], 1, "'ended up talking for hours'.")]),
    R("My Grandfather's Watch (השעון של סבא שלי)",
      ...
      [g("mechanism", "noun", "מנגנון", "A complex mechanism.", "מנגנון"), g("worn", "adjective", "שחוק, פגום משימוש", "A worn part.", "שחוק/בלוי"), g("wound", "verb", "כיוון/מתח (שעון), עבר של wind", "I wound the clock.", "כיוון (שעון)")],
      [q("Why had the watch stopped working?", ["It was never used", "A part was worn out", "It got wet", "It was too old to fix"], 1, "'a single worn part that needed replacing'."), q("How did the writer feel when the watch worked again?", ["Disappointed", "Like getting a piece of his grandfather back", "Annoyed at the cost", "Indifferent"], 1, "'it felt like getting a small piece of my grandfather back'.")]),
    R("Changing Careers at Thirty (שינוי קריירה בגיל שלושים)",
      ...
      [g("reckless", "adjective", "פזיז, לא אחראי", "A reckless decision.", "פזיז"), g("shadowing", "verb", "ליווי מקצועי לצורך למידה", "She spent a day shadowing a doctor.", "ליווי/צל (לצורכי למידה)"), g("regretted", "verb", "התחרט על", "He never regretted it.", "התחרט")],
      [q("What was Noa's job before she retrained?", ["Physiotherapist", "Accountant", "Student", "Clinic manager"], 1, "'After eight years as an accountant'."), q("What kept her motivated during the hard first year?", ["A higher salary", "Watching a patient recover during a shadowing day", "Pressure from friends", "A promise from her old job"], 1, "'watching a patient walk again after months of treatment'.")]),
    R("The Marathon I Almost Quit (המרתון שכמעט פרשתי ממנו)",
      ...
      [g("struggling", "verb", "נאבק בקושי", "She was struggling to keep up.", "נאבק"), g("aim for", "phrase", "לשאוף ל-, לכוון ל-", "Aim for the door.", "לכוון ל-/לשאוף ל-"), g("crossed the line", "phrase", "חצה את קו הסיום", "She crossed the line first.", "חצה את הקו")],
      [q("What strategy did the stranger suggest?", ["Stop and rest", "Focus on the next lamppost, not the finish line", "Run faster", "Quit together"], 1, "'aim for the next lamppost instead of thinking about the finish line'."), q("How does the writer feel about the final time?", ["Disappointed by the slow time", "Proud despite being slower than planned", "Angry at the stranger", "Indifferent"], 1, "'I have never been prouder of a finishing time in my life'.")]),
  ],
  C1: [
